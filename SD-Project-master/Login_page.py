...
class Users:
    ...
    def home_page(self,i=0):
        ...
        self.window.appearance_mode = customtkinter.CTkButton(master=self.l_frame,width=220,height=40,text="Appearance   ",corner_radius=0,fg_color="#333333",hover_color="#2e2e2e",image=customtkinter.CTkImage(Image.open("coins-solid.png")),command=self.print)
        self.window.appearance_mode.place(y=500)
