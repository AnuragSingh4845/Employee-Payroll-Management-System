...
class Users:
    ...
    def home_page(self,i=0):
        ...
        self.window.appearance_mode = customtkinter.CTkButton(master=self.l_frame,values=["Dark","Light","System"],command=self.change_appearance_mode_event)
        self.window.appearance_mode.grid(row=1, column=1,padx=0, pady=0,columnspan=1, sticky="ew")
